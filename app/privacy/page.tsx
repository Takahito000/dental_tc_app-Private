      ...
      <main className="mx-auto max-w-3xl px-5 py-12 leading-loose">
        ...
        <section className="mt-10">
          ...
          <p className="mt-3 text-sm text-ink-soft">
            本ツール（デンピストAI）では、患者さまのお名前・連絡先等の個人情報を入力・保存する欄はありません。治療方針に関する13項目の選択内容および生成されたシートは、個人を特定できる情報を一切含みません。これらの情報は、医院ごとに発行される匿名の管理IDと紐づけて、サービス提供に必要な期間、当方のサーバーに保存されます。保存された情報は、サービスの品質向上および発行履歴の確認のために利用し、患者さまを特定する目的では使用いたしません。
          </p>
        </section>
