...
async function POST(req) {
    try {
        ...
        try {
            ...
            const { data: logData, error: logError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["supabase"].from("usage_logs").insert({
                clinic_id: demoClinicId,
                staff_name: "衛生士"
            }).select("patient_anon_id").single();
            if (!logError && logData) {
...
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://aqicsnqemgtmbixnrtxp.supabase.co");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1vxp_ay._.js.map